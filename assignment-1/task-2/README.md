To run task 2.1, you can execute the `script.sh` file. To do this, open your terminal and navigate to the directory where the file is located. Then, run the following command:
